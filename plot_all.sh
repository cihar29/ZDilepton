...
if [ $# -eq 2 ] ; then
  ...
  xmaxs=( 1000 1 5 2000 1 5 2000 3000 5 1000 5 600 1000
          ...
          5 5 5 5 5 5 10 5 2000 2000 5000 3 3 80)
  ...
  for ((i=0;i<${#hists[@]};++i)); do
    ...
    rebin="2"
    if [[ "${hists[i]}" == *"met"* && "${hists[i]}" != "dphi"* ]] ; then
    ...
    lines=( "dataFileName   ${dir}${dataset}_${channel}.root"
            ...
            "sigScales      10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10 10"
            "leftText       CMS"
            "rightText      Run 2016 - 35.9 fb^{-1} (13 TeV)"
            "logx           false"
            "logy           ${logy}"
            "subplot        ${subplot}"
            "outName        plots/${hists[i]}"
            "hname          ${cut}_${hists[i]}"
            "xmin           ${xmins[i]}"
            "xmax           ${xmaxs[i]}"
            "ymin           0"
