...
if [ $# -eq 2 ] ; then
  ...
  channel=${args[0]}
  cut=${args[1]}
  dir="~broozbah/nobackup/pre_aproval/CMSSW_8_0_26_patch2/src/analysis/ZDilepton/ptrelmodeling/"
  #~broozbah/nobackup/pre_aproval/CMSSW_8_0_26_patch2/src/analysis/ZDilepton/ptrelmodeling/  ee and mm channel
  #emProbeEle/ emProbeMu/                                                                    em channel
  #off/
  #on/
  ...
  hists=( "dilepmass" "jet0btag" "jet0eta" "jet0pt" "jet1btag" "jet1eta" "jet1pt" "jethT" "lep0eta" "lep0pt" "lep1eta" "lep1pt" "metcorrpt" "sT" "masslljjm"
          ...
          "lepperp_probe" "lepperp_probe_in" "rmin_probe" )
  ...
  for ((i=0;i<${#hists[@]};++i)); do
    ...
    lines=( "dataFileName   ${dir}${dataset}_${channel}"
            "dataName       Data"
            "plotData       true"
            "mcFileNames    ${dir}TTbar0-700_${channel} ${dir}TTbar700-1000_${channel} ${dir}TTbar1000-inf_${channel} ${dir}DYhigh_${channel} ${dir}DYlow_${channel} ${dir}STschannel_${channel} ${dir}STtWchannel_${channel} ${dir}STtchannel_${channel} ${dir}SaTtWchannel_${channel} ${dir}SaTtchannel_${channel} ${dir}WJets_${channel} ${dir}WW_${channel} ${dir}WZ_${channel} ${dir}ZZ_${channel} ${dir}qcd30-50_Mu_${channel} ${dir}qcd50-80_Mu_${channel} ${dir}qcd80-120_Mu_${channel} ${dir}qcd120-170_Mu_${channel} ${dir}qcd170-300_Mu_${channel} ${dir}qcd300-470_Mu_${channel} ${dir}qcd470-600_Mu_${channel} ${dir}qcd600-800_Mu_${channel} ${dir}qcd800-1000_Mu_${channel} ${dir}qcd1000-inf_Mu_${channel} ${dir}qcd30-50_EM_${channel} ${dir}qcd50-80_EM_${channel} ${dir}qcd80-120_EM_${channel} ${dir}qcd120-170_EM_${channel} ${dir}qcd170-300_EM_${channel} ${dir}qcd300-inf_EM_${channel} ${dir}qcd30-80_bcToE_${channel} ${dir}qcd80-170_bcToE_${channel} ${dir}qcd170-250_bcToE_${channel} ${dir}qcd250-inf_bcToE_${channel}"
            "sigFileNames   ${dir}gluon_M-4500_${channel} ${dir}gluon_M-5000_${channel} ${dir}gluon_M-1000_${channel} ${dir}gluon_M-1250_${channel} ${dir}gluon_M-1500_${channel} ${dir}gluon_M-2000_${channel} ${dir}gluon_M-2500_${channel} ${dir}gluon_M-3000_${channel} ${dir}gluon_M-3500_${channel} ${dir}gluon_M-4000_${channel} ${dir}gluon_M-500_${channel} ${dir}gluon_M-750_${channel} ${dir}zprime_M-1000_W-10_${channel} ${dir}zprime_M-1000_W-100_${channel} ${dir}zprime_M-1000_W-300_${channel} ${dir}zprime_M-1250_W-125_${channel} ${dir}zprime_M-1250_W-12p5_${channel} ${dir}zprime_M-1500_W-15_${channel} ${dir}zprime_M-1500_W-150_${channel} ${dir}zprime_M-3000_W-300_${channel} ${dir}zprime_M-500_W-5_${channel} ${dir}zprime_M-500_W-50_${channel} ${dir}zprime_M-750_W-7p5_${channel} ${dir}zprime_M-750_W-75_${channel} ${dir}zprime_M-2000_W-20_${channel} ${dir}zprime_M-2000_W-200_${channel} ${dir}zprime_M-2000_W-600_${channel} ${dir}zprime_M-2500_W-25_${channel} ${dir}zprime_M-2500_W-250_${channel} ${dir}zprime_M-3000_W-30_${channel} ${dir}zprime_M-3000_W-900_${channel} ${dir}zprime_M-3500_W-35_${channel} ${dir}zprime_M-3500_W-350_${channel} ${dir}zprime_M-4000_W-40_${channel} ${dir}zprime_M-4000_W-400_${channel} ${dir}zprime_M-4000_W-1200_${channel} ${dir}zprime_M-4500_W-45_${channel} ${dir}zprime_M-4500_W-450_${channel} ${dir}zprime_M-5000_W-50_${channel} ${dir}zprime_M-5000_W-500_${channel} ${dir}zprime_M-5000_W-1500_${channel}"
            "sigScale       10"
            "leftText       CMS"
